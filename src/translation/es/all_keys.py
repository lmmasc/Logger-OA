...
MENUS_TRANSLATIONS = {
    ...
    "menu_export_txt": "Exportar como TXT",
    "menu_export_csv": "Exportar como CSV",
    "menu_export_adi": "Exportar como ADI",
    "menu_export_pdf": "Exportar como PDF",
    "menu_export_whatsapp": "Exportar para WhatsApp",
    "menu_close": "Cerrar",
    "menu_import_from_pdf": "Importar desde PDF",
    "menu_import_from_excel": "Importar desde Excel",
    "menu_import_from_csv": "Importar desde CSV",
    "import_from_pdf": "Seleccionar archivo PDF",
    "import_from_excel": "Seleccionar archivo Excel",
    "import_from_csv": "Seleccionar archivo CSV",
    ...
    "menu_create_backup": "Crear respaldo",
    "menu_restore_backup": "Restaurar respaldo",
    "menu_import_from_db": "Importar desde base externa",
    "menu_database_section_backup": "Respaldo",
    "menu_database_section_import": "Importar",
    "menu_database_section_delete": "Borrar",
    "menu_database_section_export": "Exportar",
...
TABLE_HEADERS_TRANSLATIONS = {
    # Log Operativo headers
    "log_operative_table_header_callsign": "Indicativo",
    "log_operative_table_header_name": "Nombre",
    "log_operative_table_header_country": "País",
    "log_operative_table_header_region": "Región",
    "log_operative_table_header_station": "Estación",
    "log_operative_table_header_energy": "Energía",
    "log_operative_table_header_power": "Pot.",
    ...
    "log_operative_table_header_obs": "Observaciones",
    # Export headers for CSV/TXT (Log Operativo)
    # Export headers for TXT (Log Operativo)
    "log_operative_export_txt_header_callsign": "Indicativo",
    "log_operative_export_txt_header_name": "Nombre",
    "log_operative_export_txt_header_country": "País",
    "log_operative_export_txt_header_region": "Región",
    "log_operative_export_txt_header_station": "Estación",
    "log_operative_export_txt_header_energy": "Energía",
    "log_operative_export_txt_header_power": "Potencia",
    "log_operative_export_txt_header_rs_rx": "RS (RX)",
    "log_operative_export_txt_header_rs_tx": "RS (TX)",
    "log_operative_export_txt_header_qtr_oa": "Hora OA",
    "log_operative_export_txt_header_qtr_utc": "Hora UTC",
    "log_operative_export_txt_header_obs": "Observaciones",
    # Export headers for TXT (Log Concurso)
    "log_contest_export_txt_header_callsign": "Indicativo",
    "log_contest_export_txt_header_name": "Nombre",
    "log_contest_export_txt_header_region": "Región",
    "log_contest_export_txt_header_qtr_oa": "Hora OA",
    "log_contest_export_txt_header_rs_rx": "RS (RX)",
    "log_contest_export_txt_header_exchange_received": "Intercambio recibido",
    "log_contest_export_txt_header_rs_tx": "RS (TX)",
    "log_contest_export_txt_header_exchange_sent": "Intercambio enviado",
    "log_contest_export_txt_header_observations": "Observaciones",
    "log_operative_export_csv_header_callsign": "Indicativo",
    "log_operative_export_csv_header_name": "Nombre",
    "log_operative_export_csv_header_country": "País",
    "log_operative_export_csv_header_region": "Región",
    "log_operative_export_csv_header_station": "Estación",
    "log_operative_export_csv_header_energy": "Energía",
    "log_operative_export_csv_header_power": "Potencia",
    "log_operative_export_csv_header_rs_rx": "RS (RX)",
    "log_operative_export_csv_header_rs_tx": "RS (TX)",
    "log_operative_export_csv_header_qtr_oa": "Hora OA",
    "log_operative_export_csv_header_qtr_utc": "Hora UTC",
    "log_operative_export_csv_header_obs": "Observaciones",
    # Export headers for CSV/TXT (Log Concurso)
    "log_contest_export_csv_header_callsign": "Indicativo",
    "log_contest_export_csv_header_name": "Nombre",
    "log_contest_export_csv_header_region": "Región",
    "log_contest_export_csv_header_qtr_oa": "Hora OA",
    "log_contest_export_csv_header_rs_rx": "RS (RX)",
    "log_contest_export_csv_header_exchange_received": "Intercambio recibido",
    "log_contest_export_csv_header_rs_tx": "RS (TX)",
    "log_contest_export_csv_header_exchange_sent": "Intercambio enviado",
    "log_contest_export_csv_header_observations": "Observaciones",
    # Log Concurso headers
    "log_contest_table_header_callsign": "Indicativo",
    "log_contest_table_header_name": "Nombre",
    ...
    "db_table_header_name": "Nombre",
    "db_table_header_category": "Categoría",
    "db_table_header_type": "Tipo",
    "db_table_header_region": "Región",
    "db_table_header_district": "Distrito",
    "db_table_header_province": "Provincia",
    "db_table_header_department": "Departamento",
    "db_table_header_license": "Licencia",
    "db_table_header_resolution": "Resolución",
    "db_table_header_expiration_date": "Vencimiento",
    "db_table_header_cutoff_date": "Fecha corte",
...
UI_TRANSLATIONS = {
    ...
    "ui_alert_duplicate": "Duplicado",
    "ui_alert_disabled": "Inhabilitado",
    ...
    "edit_contact_datetime_oa": "Hora OA",
    ...
    "contest_duplicate_block_msg": "El indicativo {callsign} ({name}) ya fue registrado en este bloque horario OA a las {hora_oa}. ¿Desea registrar de todas formas este contacto?",
    ...
    "qrz_button_tooltip": "Abrir QRZ.com para el indicativo",
    "db_backup_success": "Respaldo creado en: {path}",
    "db_backup_failed": "No se pudo crear el respaldo: {error}",
    "db_restore_select_backup": "Seleccionar respaldo para restaurar",
    "db_restore_success": "Base restaurada desde: {filename}",
    "db_restore_failed": "No se pudo restaurar: {error}",
    "db_import_select_file": "Importar base de datos",
    "db_import_success": "Operadores importados: {count}",
    "db_import_failed": "No se pudo importar: {error}",

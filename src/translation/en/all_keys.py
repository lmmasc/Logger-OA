...
MENUS_TRANSLATIONS = {
    ...
    "menu_export_whatsapp": "Export for WhatsApp",
    "menu_close": "Close",
...
UI_TRANSLATIONS = {
    ...
    "contest_duplicate_block_msg": "The callsign {callsign} ({name}) has already been registered in this OA time block at {hora_oa}. Do you want to register this contact anyway?",
    ...
    "qrz_button_tooltip": "Open QRZ.com for the callsign",
    "db_backup_success": "Backup created at: {path}",
    "db_backup_failed": "Could not create the backup: {error}",
    "db_restore_select_backup": "Select backup to restore",
    "db_restore_success": "Database restored from: {filename}",
    "db_restore_failed": "Could not restore: {error}",
    "db_import_select_file": "Import database",
    "db_import_success": "Imported operators: {count}",
    "db_import_failed": "Could not import: {error}",

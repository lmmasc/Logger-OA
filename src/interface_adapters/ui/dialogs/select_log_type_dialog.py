...
Diálogo para seleccionar el tipo de log a crear (operativo o concurso).
"""
...
class SelectLogTypeDialog(QDialog):
    """
    Diálogo para seleccionar el tipo de log a crear.
    Permite elegir entre log operativo y log de concurso.
    """

    def __init__(self, parent=None):
        """
        Inicializa el diálogo de selección de tipo de log.
        Args:
